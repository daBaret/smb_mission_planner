...
if __name__ == '__main__':
    ...
    parser.add_argument('waypoint_frame', type=str, help='Frame of waypoints')
    ...
    mission_planner = MissionPlanner(args.config_file_path, args.waypoint_topic_name, args.base_pose_topic_name, args.waypoint_frame)
